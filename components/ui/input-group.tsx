...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- This inline compound control keeps its div ref and sizing contract.
      role="group"
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // The native input remains the keyboard focus target; this only enlarges its pointer target.
    // oxlint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions
    <div
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- Addons may contain arbitrary text and nested controls, not a separate fieldset.
      role="group"
